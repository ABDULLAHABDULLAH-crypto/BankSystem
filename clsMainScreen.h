...
#include "clsClientScreenList.h"
#include "clsAddNewClientScreen.h"
#include "clsUpdateClientScreen.h"
#include "clsDeleteClientScreen.h"
#include "clsFindClientScreen.h"
#include "clsTransactiosScreen.h"
...
private:
    enum enMainMenueOptions {
        ...
        eManageUsers = 7, eLogInRegister=8,eShowCurrencyExhange=9,eExit = 10
    };
    ...
    {
        clsClientScreenList::ShowClientList();
    }
    ...
    static void _PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
    {
        ...
        case enMainMenueOptions::eLogInRegister:
            ...
            _GoBackToMainMenue();
            //Login();
        case enMainMenueOptions::eShowCurrencyExhange:
            system("cls");
            _CurrencyScreen();
            _GoBackToMainMenue();
